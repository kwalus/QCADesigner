...
// (schulhof@vlsi.enel.ucalgary.ca). It contains the    //
// creation code for the "Print Properties" dialog.     //
//////////////////////////////////////////////////////////
...
void create_print_design_properties_dialog (print_properties_D *dialog, print_design_OP *pPO){
  ...
  dialog->tbtnPrintOrder = create_two_pixmap_toggle_button (
    GTK_IMAGE (create_pixmap (dialog->dlgPrintProps, "print_over_then_down.xpm")),
    GTK_IMAGE (create_pixmap (dialog->dlgPrintProps, "print_down_then_over.xpm")), NULL) ;
  ...
  dialog->tbtnCenter = create_two_pixmap_toggle_button (
    GTK_IMAGE (create_pixmap (dialog->dlgPrintProps, "no_center_on_pages.xpm")),
    GTK_IMAGE (create_pixmap (dialog->dlgPrintProps, "center_on_pages.xpm")), NULL) ;
  ...
  print_dialog_add_page (PRINT_DIALOG (dialog->dlgPrintProps), dialog->scrwPrintedObjs, "Printed Objects") ;
