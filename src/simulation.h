...
int select_cells_in_radius_cv (QCADCell ***sorted_cells, QCADCell *cell, double world_radius, int the_cells_layer, int number_of_cell_layers, int *number_of_cells_in_layer, double layer_ation, QCADCell ***p_selected_cells, int **p_neighbour_layer, int **p_neighbour_index);
