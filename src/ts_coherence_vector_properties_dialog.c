...
// the ts_coherence vector simulation engine.              //
//                                                      //
//////////////////////////////////////////////////////////
...
typedef struct
  {
  GtkWidget *ts_coherence_properties_dialog;
  ...
  GtkWidget *hbox2;
  GtkWidget *ts_coherence_properties_ok_button;
  GtkWidget *ts_coherence_properties_cancel_button;
  GSList    *radio_group;
  } ts_coherence_properties_D;

static ts_coherence_properties_D ts_coherence_properties = {NULL};

static void create_ts_coherence_properties_dialog (ts_coherence_properties_D *dialog) ;
static void ts_coherence_OP_to_dialog (ts_coherence_OP *psco, ts_coherence_properties_D *dialog) ;
static void dialog_to_ts_coherence_OP (ts_coherence_OP *psco, ts_coherence_properties_D *dialog) ;
static void create_ts_coherence_properties_line (GtkWidget *table, int idx, GtkWidget **plabel, GtkWidget **pentry, GtkWidget **plblUnits, char *pszLabel, char *pszUnits, gboolean bEnableEntry) ;
static void properties_changed (GtkWidget *widget, gpointer user_data) ;

void get_ts_coherence_properties_from_user (GtkWindow *parent, ts_coherence_OP *pbo)
  {
  ts_coherence_OP scoLocal = {0} ;

  if (NULL == ts_coherence_properties.ts_coherence_properties_dialog)
    create_ts_coherence_properties_dialog (&ts_coherence_properties) ;

  gtk_window_set_transient_for (GTK_WINDOW (ts_coherence_properties.ts_coherence_properties_dialog), parent) ;

  g_object_set_data (G_OBJECT (ts_coherence_properties.ts_coherence_properties_dialog), "bIgnoreChangeSignal", (gpointer)TRUE) ;
  ts_coherence_OP_to_dialog (pbo, &ts_coherence_properties) ;
  dialog_to_ts_coherence_OP (&scoLocal, &ts_coherence_properties) ;
  ts_coherence_OP_to_dialog (&scoLocal, &ts_coherence_properties) ;
  g_object_set_data (G_OBJECT (ts_coherence_properties.ts_coherence_properties_dialog), "bIgnoreChangeSignal", (gpointer)FALSE) ;

  if (GTK_RESPONSE_OK == gtk_dialog_run (GTK_DIALOG (ts_coherence_properties.ts_coherence_properties_dialog)))
    dialog_to_ts_coherence_OP (pbo, &ts_coherence_properties) ;

  gtk_widget_hide (ts_coherence_properties.ts_coherence_properties_dialog) ;
  }
...
static void create_ts_coherence_properties_dialog (ts_coherence_properties_D *dialog)
  ...
  if (NULL != dialog->ts_coherence_properties_dialog) return ;

  dialog->ts_coherence_properties_dialog = gtk_dialog_new ();
  gtk_window_set_title (GTK_WINDOW (dialog->ts_coherence_properties_dialog), _("Three State Coherence Options"));
  gtk_window_set_resizable (GTK_WINDOW (dialog->ts_coherence_properties_dialog), FALSE);
  gtk_window_set_modal (GTK_WINDOW (dialog->ts_coherence_properties_dialog), TRUE) ;
  ...
  create_ts_coherence_properties_line (dialog->table,  0, &(label), &(dialog->T_entry),                      &lblunits, _("Temperature:"),            "K",  TRUE) ;
...
static void properties_changed (GtkWidget *widget, gpointer user_data)
  {
  ts_coherence_properties_D *dialog = (ts_coherence_properties_D *)user_data ;
  ts_coherence_OP sco ;

  if ((gboolean)g_object_get_data (G_OBJECT (dialog->ts_coherence_properties_dialog), "bIgnoreChangeSignal"))
    return ;

  dialog_to_ts_coherence_OP (&sco, dialog) ;
  }
